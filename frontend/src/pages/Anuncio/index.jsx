...
import { ArrowLeft, UsersRound, Fuel, Gauge, Toilet } from "lucide-react";
    ...
    <section className="">
      ...
      <div className="text-center mb-4 rounded-t-4xl -mt-12 px-6 py-4 relative z-10 bg-(--bc) ">
        ...
        <div className="flex justify-between text-center pt-4 border-t border-gray-200">
          <div>
            <p className="font-bold text-lg">{anuncio.nota || "4,9"}</p>
      ...
      <div className="px-(--sdp)">
        ...
        {/* Pilotos parceiros */}
        <button className="w-full mb-4 px-4 py-2 bg-white rounded-full font-semibold transition flex gap-2 justify-center">
          <span className="px-2 bg-gray-200 rounded-full">2</span>
          <p>Mostrar pilotos parceiros</p>
        </button>
