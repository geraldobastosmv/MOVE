...
const CardCategory = ({ id, title, link, description, backgroundImg }) => {
  ...
  return (
    <div
      className="flex-shrink-0 w-[80vw] sm:w-[300px] flex flex-col items-center 
             bg-white rounded-4xl shadow-2xl h-full 
    ...
    >
      <img
        src={backgroundImg}
        alt={id}
        className="rounded-4xl p-2 w-full h-40 object-cover"
      />
